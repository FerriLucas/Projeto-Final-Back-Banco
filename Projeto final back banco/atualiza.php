...
$row = mysqli_fetech_assoc($result);
...
if(isset($_POST['nomeProduto'])){
    ...
    $sql = "UPDATE `produto` SET nome = 'nomeProduto',desc 'descPro',preco = 'precoProd',tipo ='tipoProd' WHERE id=$id";
    $result = mysqli_query($con,$sql);
    if($result){
        escho "Dados atualizados com sucesso";
